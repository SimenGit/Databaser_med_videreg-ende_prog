...
CREATE TABLE bok_forfatter(
  ...
  CONSTRAINT bok_forfatter_fk1 FOREIGN KEY(bok_id)REFERENCES bok(bok_id),
  CONSTRAINT bok_forfatter_fk2 FOREIGN KEY(forfatter_id)REFERENCES forfatter(forfatter_id)
);
...
INSERT INTO bok VALUES(DEFAULT,'Topenes',1995,7);
...
INSERT INTO bok VALUES(DEFAULT,'Klosterkronike',1982,3);
INSERT INTO bok VALUES(DEFAULT,'Universet',1988,3);
INSERT INTO bok VALUES(DEFAULT,'Naalen',1978,3);
INSERT INTO bok VALUES(DEFAULT,'Markens grode',1917,2);
...
INSERT INTO konsulent VALUES(DEFAULT, 'Bjorn', 'Jensen', 'bjornj@yyy.com');
INSERT INTO konsulent VALUES(DEFAULT, 'Anne', 'Aas', 'anne.as@zzz.com');
...
SELECT forlag_navn, telefon, adresse FROM forlag WHERE telefon LIKE '2%'
UNION
SELECT forlag_navn, telefon, adresse FROM forlag WHERE telefon NOT LIKE '2%'
UNION
SELECT forlag_navn, telefon, adresse FROM forlag;

-- OPPGAVE 2_b
-- Sett opp SQL-setninger som finner gjennomsnittlig alder på forfattere der fødselsåret er oppgitt. For forfattere der dødsåret ikke er oppgitt,
...
SELECT CONCAT(COUNT(*) / (SELECT COUNT(*) FROM forfatter)* 100) AS prosent FROM forfatterview;
