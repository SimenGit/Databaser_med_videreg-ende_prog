...
class TestBonusmedlem {
    public static void main(String[] args) throws Exception {
        ...
        BasicMedlem b1 = new BasicMedlem(100, ole, LocalDate.of(2006, 2, 15), 0);



        b1.registrerPoeng(30000.0);
        if (b1.finnKvalPoeng(testdato) > 25 && b1.getPoeng() == 30000.0) {
            System.out.println("Test 1 ok");
        }
        b1.registrerPoeng(15000.0);
        if (b1.getPoeng() == 45000.0) {
            System.out.println("Test 2 ok");
        }

        BasicMedlem b2 = new BasicMedlem(110, tove, LocalDate.of(2007, 3, 5), 0);
